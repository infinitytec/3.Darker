...
(function() {
    ...
    //Right-click & pop-ups
    GM_addStyle(".context-menu_context-menu_2SJM-, .blocklyWidgetDiv .goog-menu, .Popover-body {background: #202020 !important; color: white !important; border: 1px solid white;} .goog-menuitem-content, .color-picker_row-header_173LQ {color: white;} /*Highlight*/ .blocklyWidgetDiv .goog-menuitem-highlight, .blocklyWidgetDiv .goog-menuitem-hover, .context-menu_menu-item_3cioN:hover {background-color:#3d4e72 !important;}");
    //Palette
    GM_addStyle(".blocklyFlyoutBackground {fill: #252525 !important;}");
    //Palette text
    GM_addStyle(".blocklyFlyoutLabelText{fill: white !important;}");
    //Toolbox
    GM_addStyle(".blocklyToolboxDiv, .scratchCategoryMenu {background: #252525; color: white;}");
    //Selected category
    GM_addStyle(".scratchCategoryMenuItem.categorySelected {background: #ffffff22;}");
    //Sprite and stage selection area
    GM_addStyle(".sprite-selector_sprite-selector_2KgCX, .stage-selector_stage-selector_3oWOr, .stage-selector_label_1MCfr, .stage-selector_count_2QK7D {background: #252525; color: white;}");
    GM_addStyle(".sprite-info_sprite-info_3EyZh, .stage-selector_header_2GVr1, .stage-selector_header-title_33xCt, .stage-selector_header-title_33xCt, .sprite-selector-item_sprite-selector-item_kQm-i:hover {background: #202020; color: white;}");
    //Palette Buttons
    ...
    GM_addStyle(".blocklyFlyoutButton .blocklyText {fill: white !important;");
     //Backpack header
    GM_addStyle(".backpack_backpack-header_6ltCS {background: #202020; color: white;}");
     //Backpack
    GM_addStyle(".backpack_backpack-list-inner_10a2A {background: #202020;} .backpack_backpack-item_hwqzQ{background: white;}");
    ...
    GM_addStyle(".asset-panel_wrapper_366X0{background: #202020; color: white;} .sound-editor_effect-button_2zuzT, .sound-editor_trim-button_lSENI {color: white;}");
    ...
    //Tabs
    GM_addStyle(".gui_tab_27Unf.gui_is-selected_sHAiu{background: #202020;color: white;}.gui_tab_27Unf{background: #202020;color: white;} .gui_tab_27Unf:hover{background: #252525;color: white;}");
    //New variable/list/custom block
    GM_addStyle(".prompt_body_18Z-I, .custom-procedures_body_SQBv6, div.custom-procedures_option-card_BtHt3 {background: #202020; color: white;} .custom-procedures_button-row_2jBu3 > button:nth-child(1), .prompt_button-row_3Wc5Z > button:nth-child(1),.prompt_button-row_3Wc5Z > button:nth-child(1) {background: #ff3a5b;}");
    //Fullscreen view
    ...
    //Library background
    GM_addStyle(".library_library-scroll-grid_1jyXm, .modal_modal-content_1h3ll.modal_full-screen_FA4cr {background:#202020; color: white;} ");
    //Library items & filter bar
    GM_addStyle(".library-item_library-item-extension_3xus9, .library-item_library-item_1DcMO, .library_filter-bar_1W0DW {background: #202020; .library-item_library-item-extension_3xus9 span, .library-item_featured-extension-metadata_3D8E8 {color: white !important;}");
    //Text input
    GM_addStyle("input[type=text], .input_input-form_1Y0wX, .prompt_variable-name-text-input_1iu8- {background: #252525; color: white !important;} input[type=text]:hover, input[type=text]:focus {background: #3f5076;}");
